  ...
  return (
    <div>
      ...
      <div className="flex justify-center z-0">
        <div className="absolute rounded-t-[105px] border-t-4 border-l-4 border-r-4 border-solid border-secondary w-full md:w-3/5 h-2/5 md:h-1/3"></div>
        <div className="absolute rounded-t-[105px] border-t-4 border-l-4 border-r-4 border-solid border-heading w-4/5 md:w-2/3 h-2/5 md:h-1/3"></div>
      </div>
