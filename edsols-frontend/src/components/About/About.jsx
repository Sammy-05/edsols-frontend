...
const About = () => {
  return (
    <div className="mt-32" >
      ...
      <div className="grid grid-cols-5 pt-8 gap-x-20" id="about-section">
        <div className="col-span-2 flex flex-col justify-center">
          ...
          <div className="absolute ml-20">
            <h1 className="font-bold text-4xl text-subheading pb-2">
              WHY CHOOSE
            </h1>
            <h1 className="font-bold text-4xl text-heading pt-2">EDSOLS?</h1>
          </div>
        </div>
        ...
        <div className="col-span-3 mr-20">
          ...
          {ABT1.map((item) => {
            return (
              <div className="py-3">
                <h3 className="text-subheading font-semibold text-lg">
                  {item.heading}
                </h3>
                <p className="text-text text-lg">{item.text}</p>
              </div>
            );
          })}
        </div>
