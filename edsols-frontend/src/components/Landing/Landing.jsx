...
const Landing = () => {
  ...
  return (
    <div className="mx-20 z-20">
      <div>
        <h1 className="text-5xl font-bold text-heading">Crafting Knowledge,</h1>
            ...
            {isHovered === 3 && (
              ...
              >
                ...
                <p className="mt-5">
                  ...
                  merges skill with innovation to craft inspiring and engaging
                  educational paths for learners.
                </p>
                <a
                  href="#about-section"
                  onClick={scrollToAbout}
          ...
          {isHovered === 0 && (
            <div className="ml-20 flex flex-col">
              <p className="w-3/4 text-2xl">
                Welcome to Edsols, where learning comes alive with our
                comprehensive curriculum development that meets global education
                standards.
              </p>
